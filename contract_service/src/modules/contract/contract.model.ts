...
class Contract extends BaseModel {
  ...
  public async getAprValue( factory:string, abi: any): Promise<string> {
    try {
      // const web3Obj = await this.callW3Objects(chainId);
      //  console.log("hereeeeerrrrrrrrrreeeeeeeeeeee")
       return 'sucesss new'
    //   const factoryContractObj = new web3Obj.eth.Contract(factoryContract, factory);
    //  return await factoryContractObj.methods.allPairsLength().call();
    } catch (err) {
  ...
  public async calculateAPR(chainId:any, factory:string): Promise<string> {
    try {
      // const web3Obj = await this.callW3Objects(chainId);
      //  console.log("hereeeeerrrrrrrrrreeeeeeeeeeee")
      // const resp = this.calculateAPRValue()
       return 'sucesss new'
    //   const factoryContractObj = new web3Obj.eth.Contract(factoryContract, factory);
    //  return await factoryContractObj.methods.allPairsLength().call();
    } catch (err) {
